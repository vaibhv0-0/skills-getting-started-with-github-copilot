...
activities = {
    "Basketball Team": {
        ...
        "Soccer Club": {
        "description": "Play soccer with fellow students in a casual and competitive environment",
        "schedule": "Tuesdays and Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 22,
        "participants": ["james@mergington.edu"]
        },
        "Digital Art Club": {
        "description": "Create digital art and graphic design projects using modern software",
